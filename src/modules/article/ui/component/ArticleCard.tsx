      ...
      >
          ...
          <div className="w-full flex items-center gap-2">
            <div className="relative aspect-square">
              <Avatar className="w-8 h-8">
                ...
                />
                <AvatarFallback>{data.author.name || "Unknown"}</AvatarFallback>
              </Avatar>
            </div>
        ...
        <div className="w-full h-full relative aspect- flex items-center justify-center">
          <Image
            ...
            width={100}
            height={100}
            className="object-contain w-24 sm:w-36 md:w-44 lg:w-48 h-[120px] max-h-[120px] object-center max-w-[170px]"
            priority
          />
        </div>
      </motion.div>}
